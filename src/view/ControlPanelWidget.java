...
public class ControlPanelWidget extends RoundedPanel {
    ...
    public ControlPanelWidget(GameWidget owner) {
        ...
        cancelButton.addActionListener(e -> _owner.getGame().activePlayer().cancelMove());
        confirmButton.addActionListener(e -> _owner.getGame().activePlayer().cellSelectionFinished());
